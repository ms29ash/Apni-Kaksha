        ...
        <Section>
            ...
            <Container>
                ...
                <CourseCard title="RUDRA Batch - Class XII JEE" points={['650+ Hours of Lecture Content',
                    ...
                    '3000+ Daily Practice Questions+Solutions']} type="left" />
                ...
                <CourseCard title="Yoddha Batch : Class 12th Boards Term 2" points={['This batch is for Class 12th Boards',
                    ...
                    'Live Sessions on every Sunday with Aman Bhaiya']} type="right" />
...
const Section = tw.section` max-w-screen my-12 px-16`
const Container = tw.div`flex xl:flex-row flex-col flex-wrap justify-center gap-x-3 gap-y-8  w-full `